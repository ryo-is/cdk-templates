...
export class IAMCreator {
  public static createDDBReadWriteRoleStatement(
    tableArn: string
  ): PolicyStatement {
  ...
  public static createRoleStatement(
    actionsValue: string[],
  ...
  public static createAppSyncServiceRole(
    self: cdk.Construct,
    roleName: string
  ): Role {
    return new Role(self, roleName, {
      assumedBy: new ServicePrincipal("appsync.amazonaws.com")
    })
  }

  // Create IoTCore ServiceRole
  public static createIoTCoreServiceRole(
    self: cdk.Construct,
    roleName: string
  ): Role {
    return new Role(self, roleName, {
