...
export class APIGatewayCreator {
   ...
   * @param {Boolean} cors
   */
  static AddMethod(api: apigateway.RestApi, method: string, handler: lambda.IFunction, cors: boolean = true) {
   ...
   * @param {Boolean} cors
   */
  static AddResourceAndMethod(api: apigateway.RestApi, resource: string , method: string, handler: lambda.IFunction, cors: boolean = true) {
